export default function BlogAdminPage() {
    return (
        <section className="w-full pt-15">
            <div className="max-w-4xl pl-5 flex flex-col gap-7">
                ...
                <div className="p-5 border flex flex-col gap-5">
                    ...
                    <div className="flex gap-4 items-center">
                        <span className="min-w-[80px]">Image answers</span>
                        <textarea name="imagesAnswers" className="w-full border border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-gray-400 " />
                    </div>
