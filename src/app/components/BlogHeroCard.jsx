        ...
        <div className="relative w-full h-[90vh]">
            ...
            <div className="absolute top-0 py-25 lg:py-40 left-0 right-0 bottom-0 text-center flex flex-col justify-between text-white">
                <div className="">
                    ...
                    <h1 className="text-center text-2xl lg:text-4xl lg:px-20 text-white font-bold">Beautiful Living Rooms Start With the Right Details</h1>
                </div>

                <div className="px-10 md:px-25 flex flex-col">
                    <span className="text-xl">
                        Decorative wall panels that redefine modern interiors.
                        Explore ideas for a stylish and comfortable home.
                    </span>
                    <div className="mt-5">
                    <button className="px-6 py-2 bg-white text-black text-xl rounded-xl border cursor-pointer hover:bg-[#654321] hover:text-white transition active:bg-[#654321]">See Post</button>
                    </div>
                </div>
            </div>
        </div>
